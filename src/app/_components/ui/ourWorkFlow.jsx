        ...
        <div className="p-8">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2 text-lime-400">
              ...
              <span className="text-sm font-bold text-white">dsaasdaWorkflow</span>
            </div>
          </div>
          <div className="flex mt-4">
            <p className="text-6xl text-left text-white max-w-full font-semibold">
              This is how our <span className="text-lime-400 font-cursive">Workflows</span>
            </p>
          </div>
        </div>
      </motion.div>
            ...
            {workflowSteps.map((step, index) => (
              <motion.div
                ...
                className={`transition-all duration-300 transform ${
                  activeStep === index ? "opacity-100 translate-x-4" : "opacity-40 hover:opacity-60"
                }`}
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-xl font-medium text-gray-200 mb-1">{step.title}</h2>
